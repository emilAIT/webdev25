...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (addFriendInput) {
        ...
        addFriendInput.addEventListener('keypress', function(e) {
            if (e.key === 'Enter' && addFriendButton) {
                e.preventDefault();
                    ...
                    data.forEach(user => {
                        ...
                        div.innerHTML = `
                            <div class="search-result-avatar">
                                <img src="${user.avatar || '/static/images/profile_photo.jpg'}" alt="${user.full_name || user.username}">
                            </div>
    ...
    if (addFriendButton) {
        addFriendButton.addEventListener('click', function() {
            ...
            .then(data => {
                ...
                if (window.BlinkWebSocket && window.BlinkWebSocket.connectPresenceWebSocket) {
                    window.BlinkWebSocket.connectPresenceWebSocket();
                }
